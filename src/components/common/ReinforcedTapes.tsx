...
export default function ReinforcedTapes() {
  const t = useTranslations('ReinforcedTapes');
          ...
          {products.map((product) => (
            ...
            >
              <div className="flex items-center gap-5 sm:gap-8 py-6 px-2 sm:px-4">
                <div className="relative w-[165px] sm:w-[225px] aspect-[3/2] shrink-0 overflow-hidden rounded-lg bg-gray-100">
                  {' '}
                  <Image
                    src={product.image}
                    alt={product.title}
                ...
                <div className="flex flex-1 items-center justify-between gap-4">
                  ...
                  <span className="text-xl text-gray-400 transition-all duration-300 group-hover:text-red-600 group-hover:translate-x-1">
                    →
                  </span>
                </div>
              </div>
