...
export default function Bianco() {
  ...
  //   {
  //     id: 1,
  //     photo: '/images/1.1.webp',
  //   },
  //   {
  //     id: 2,
  //     photo: '/images/1.2.webp',
  //   },
  //   {
  //     id: 3,
  //     photo: '/images/1.3.webp',
  //   },
  //   {
  //     id: 4,
  //     photo: '/images/1.4.webp',
  //   },
  //   {
  //     id: 5,
  //     photo: '/images/1.5.webp',
  //   },
  // ];
  ...
  const boardMembers =
    locale === 'en'
      ? [
          { id: 1, photo: '/images/1.1.webp' },
          { id: 2, photo: '/images/1.2.webp' },
          { id: 3, photo: '/images/1.3.webp' },
          { id: 4, photo: '/images/en/1.4.webp' },
          { id: 5, photo: '/images/1.5.webp' },
        ]
      : [
          { id: 1, photo: '/images/1.1.webp' },
          { id: 2, photo: '/images/1.2.webp' },
          { id: 3, photo: '/images/1.3.webp' },
          { id: 4, photo: '/images/ua/1.4.webp' },
          { id: 5, photo: '/images/1.5.webp' },
        ];
