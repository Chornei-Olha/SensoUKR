...
export default function Marrone() {
  ...
  //   {
  //     id: 1,
  //     photo: '/images/2.1.webp',
  //   },
  //   {
  //     id: 2,
  //     photo: '/images/2.2.webp',
  //   },
  //   {
  //     id: 3,
  //     photo: '/images/2.3.webp',
  //   },
  //   {
  //     id: 4,
  //     photo: '/images/2.4.webp',
  //   },
  //   {
  //     id: 5,
  //     photo: '/images/2.5.webp',
  //   },
  // ];
  ...
  const boardMembers =
    locale === 'en'
      ? [
          { id: 1, photo: '/images/2.1.webp' },
          { id: 2, photo: '/images/2.2.webp' },
          { id: 3, photo: '/images/2.3.webp' },
          { id: 4, photo: '/images/en/1.4.webp' },
          { id: 5, photo: '/images/2.5.webp' },
        ]
      : [
          { id: 1, photo: '/images/2.1.webp' },
          { id: 2, photo: '/images/2.2.webp' },
          { id: 3, photo: '/images/2.3.webp' },
          { id: 4, photo: '/images/ua/2.4.webp' },
          { id: 5, photo: '/images/2.5.webp' },
        ];
