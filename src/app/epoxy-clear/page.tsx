...
export default function EpoxyClearPage() {
  const t = useTranslations('EpoxyClear');
  const b = useTranslations('Breadcrumbs');

  const advantages = Array.from({ length: 6 }, (_, index) => t(`advantages.${index + 1}`));
